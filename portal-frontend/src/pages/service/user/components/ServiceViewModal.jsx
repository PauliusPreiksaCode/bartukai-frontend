...
export const ServiceViewModal = ({ open, handleClose, handleOrderClick, service}) => {
  ...
  return (
    <Dialog open={open} onClose={handleClose} fullWidth={true} maxWidth={'xl'}>
      ...
      <DialogActions>
        ...
        <Button variant="contained" color="success" onClick={handleOrderClick}>Užsakyti</Button>
      </DialogActions>
    </Dialog>
  );
};